...
def squares(numbers, squares_list):
    ...
    print('square_list inside process: ', squares_list)
...
def cubes(numbers, result):
    ...
    print('result Array inside process/function:', result[::])
...
if __name__ == '__main__':
    ...
    print('squares_list outside process:', squares_list)
    ...
    p1.start()
    p1.join()
    print('result Array outside process:', result[::])